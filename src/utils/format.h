...
#ifdef _WIN32
FLOWONNX_API std::string wide2utf8(const std::wstring &s);
#endif

FLOWONNX_API std::string formatText(const std::string &format, const std::vector<std::string> &args);
